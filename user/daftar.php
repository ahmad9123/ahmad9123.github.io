...
<head>
    ...
    <title>Aisyah University: Pendaftaran</title>
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a href="index.php"><img src="../Ahmad.png" alt="logo" width="100%"></a>
            </div>
            <div class="main-menu">
                            ...
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                         ...
                                         <br>Sistem ini disusun oleh TIMAhmad20UAP
                                         <br><br>
                                         Panduan Pendaftaran:
                                         ...
                                         <br>
                                         <br>*Note: Pihak Universitas baru akan menerima data Anda setelah Anda klik 'Confirm'
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!------------------ Pisahin ------------------->
        ...
        <footer>
            <div class="footer-area">
                <p>PMB Online By TIMAhmad20UAP</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
